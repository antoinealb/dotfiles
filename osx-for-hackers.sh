...
echo ""
echo "Showing all filename extensions in Finder by default? (y/n)"
...
echo ""
echo "Preventing Time Machine from prompting to use new hard drives as backup volume? (y/n)"
defaults write com.apple.TimeMachine DoNotOfferNewDisksForBackup -bool true

echo ""
echo "Disabling local Time Machine backups? (This can take up a ton of SSD space on <128GB SSDs) (y/n)"
